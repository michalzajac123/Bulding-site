<template>
  ...
  >
    <div class="relative overflow-hidden h-64">
      <img
        :src="props.image"
        :alt="props.imageAlt || 'Realizacja budowlana'"
      ...
      >
        <h3 class="text-2xl font-semibold tracking-tight">Realizacja</h3>
      </div>
    </div>
    <div class="p-6 mb-12">
      <p class="text-gray-600 leading-relaxed">
        <span
          class="block text-xl font-bold text-gray-900 mb-3 transition-colors duration-300 group-hover:text-gray-800"
          >{{ props.title }}</span
        >
        {{ props.description }}
      </p>
      ...
      >
        <span class="text-sm font-medium text-gray-500">
          ...
          <span class="text-gray-800 font-semibold">{{ props.area }} m²</span>
        </span>
      </div>
    </div>
  </div>
